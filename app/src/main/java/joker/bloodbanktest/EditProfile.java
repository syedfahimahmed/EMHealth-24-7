...
public class EditProfile extends Activity implements AdapterView.OnItemSelectedListener{
    ...
    EditText curName,curMobNo,curEmail,curLocation,curAge,curWeight,curLastDate, hiv, hp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hiv = (EditText)findViewById(R.id.hivET);
        hp = (EditText)findViewById(R.id.hpET);
        ...
        saveUpdateInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String h1 = hiv.getText().toString();
                String h2 = hp.getText().toString();
                ...
                if(updateName.isEmpty()||updateMobNo.isEmpty()||updateEmail.isEmpty()||updateLocation.isEmpty()||
                        ...
                        ||updateWeight.isEmpty() ||h1.isEmpty() || h2.isEmpty())
                {
                ...
                else
                {
                    ...
                    c.setBloodborneHiv(h1);
                    c.setBloodborneHp(h2);
    ...
    public void setCurrentInfo()
    {
        ...
        t = currentInfo.get(7)+ "-" + currentInfo.get(8)+ "-" + currentInfo.get(9);
        curLastDate.setText(t);
        hiv.setText(currentInfo.get(10));
        hp.setText(currentInfo.get(11));
    }
    @Override
